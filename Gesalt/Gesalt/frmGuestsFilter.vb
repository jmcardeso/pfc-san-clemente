...
Public Class frmGuestsFilter
    ...
    Const SELECT_Guest As String = "select * from guest where "
    Const ORDERBY_Guest As String = " order by last_name"

    Dim LocRM As New ResourceManager("Gesalt.WinFormStrings", GetType(frmGuestsFilter).Assembly)
    ...
    Public Sub AddFilterLine()
        ...
        CmbFields.Items.AddRange(FieldsGuestName)
