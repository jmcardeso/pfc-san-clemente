...
Public Class DBTypeOleDB
    ...
    Public Overloads ReadOnly Property csBuilder As OleDbConnectionStringBuilder Implements IDBType(Of OleDbConnectionStringBuilder, OleDbConnection, OleDbDataAdapter).csBuilder
        Get
    ...
    Public Overloads Property dbCon As OleDbConnection Implements IDBType(Of OleDbConnectionStringBuilder, OleDbConnection, OleDbDataAdapter).dbCon

    ''' <summary>
    ''' Obtiene o establece un DataAdapter para la base de datos OleDb.
    ''' </summary>
    ''' <returns>DataAdapter para la base de datos OleDb.</returns>
    Public Overloads Property dtaPrueba As OleDbDataAdapter Implements IDBType(Of OleDbConnectionStringBuilder, OleDbConnection, OleDbDataAdapter).dtaPrueba
End Class